...
public class EconSuggestReactionComplete extends ListenerAdapter {
    public void onGuildMessageReactionAdd(GuildMessageReactionAddEvent event) {
        ...
        try {
            ...
            if (emojichannel.equals(channel)) {
                if (event.getReactionEmote().getId().equals("578572720749674511")) {
                    ...
                    if (RankTester == 1) {
                        ...
                        embed.addField("<:upvote:578572720749674511> Accepted:", "`" + event.getMember().getUser().getAsTag() + "` [" + reaction + "] \nCheck <#576141648514252800> For all Changes!", false);
