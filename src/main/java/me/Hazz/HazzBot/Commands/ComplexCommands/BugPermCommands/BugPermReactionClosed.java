...
public class BugPermReactionClosed extends ListenerAdapter {
    public void onGuildMessageReactionAdd(GuildMessageReactionAddEvent event) {
        ...
        if (RankTester == 1) {
            ...
            embed.addField(":no_entry: Bug Not Replicable, Closed By:", "`" + event.getMember().getUser().getAsTag() + "` [" + now + "]", false);
