...
public class AddCarrots {
    public AddCarrots(String A, Member name, GuildMessageReceivedEvent event) {
        ...
        embed.addField("Carrots Added", "`" + Amount + "` carrots added to " + name.getUser().getAsMention() + "'s Fridge.\n **New Total: `" + user.Carrots + "`** carrots ", false);
